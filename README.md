# Knowledge Pack
----
This Pack is designed for Cribl Stream users at all levels of experience, and maintained by Cribl Solution Engineers. Every time we solve an interesting use case, our intent is to add it to this Knowledge Pack.
...
The Cribl Stream techniques explained in the Pack include how to:
...
* Open any Comment in the Functions list. The Comment gives you links to relevant Cribl Stream docs. Open the docs in new browser tabs so you can refer to them as you work.
...
## Release Notes
---
### Version 1.0.1 - 2024-04-02
Updated Readme text.

### Version 0.5 - 2021-07-28
Initial release!

Support for: Cribl Stream Users
